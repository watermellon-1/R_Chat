...
public:
    ...
    void setupUi(QDialog *ResetDialog)
    {
        ...
        newpwd_visible = new ClickedLabel(widget_4);
        newpwd_visible->setObjectName("newpwd_visible");
        newpwd_visible->setMinimumSize(QSize(25, 0));
        newpwd_visible->setMaximumSize(QSize(25, 16777215));

        horizontalLayout_4->addWidget(newpwd_visible);
