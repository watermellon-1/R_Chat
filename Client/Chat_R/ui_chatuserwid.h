...
public:
    ...
    void setupUi(QWidget *ChatUserWid)
    {
        ...
        sizePolicy.setHeightForWidth(ChatUserWid->sizePolicy().hasHeightForWidth());
        ChatUserWid->setSizePolicy(sizePolicy);
        ...
        widget_3 = new QWidget(ChatUserWid);
        widget_3->setObjectName("widget_3");
        sizePolicy.setHeightForWidth(widget_3->sizePolicy().hasHeightForWidth());
        widget_3->setSizePolicy(sizePolicy);
        widget_3->setMinimumSize(QSize(50, 50));
        widget_3->setMaximumSize(QSize(50, 50));
        horizontalLayout_3 = new QHBoxLayout(widget_3);
        horizontalLayout_3->setSpacing(0);
        horizontalLayout_3->setObjectName("horizontalLayout_3");
        horizontalLayout_3->setContentsMargins(0, 0, 0, 0);
        time_lb = new QLabel(widget_3);
        time_lb->setObjectName("time_lb");
        time_lb->setMinimumSize(QSize(45, 30));
        time_lb->setMaximumSize(QSize(45, 30));
    ...
    void retranslateUi(QWidget *ChatUserWid)
    {
        ...
        user_name_lb->setText(QCoreApplication::translate("ChatUserWid", "Ray-test", nullptr));
        user_chat_lb->setText(QCoreApplication::translate("ChatUserWid", "SD:001010", nullptr));
        time_lb->setText(QCoreApplication::translate("ChatUserWid", "25:61", nullptr));
    } // retranslateUi
